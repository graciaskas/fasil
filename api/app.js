...
const {
  authenticate,
} = require("./src/Base/middlewares/authenticate.middleware");
...
app.use("/" + process.env.API_V + "/db", Database); // database middleware
...
app.listen(process.env.PORT || 8020, () =>
  console.log("Server on http://localhost:8020 ")
); //Server listening ...
