...
export default function Controller({ match }) {
   ...
   let App = getModuleFromPath(match.url);

   if (App === "configuration" || App === "")
      return <Configuration app={App} url={match.url} />;

   if (App === "applications")
      return <Applications app={App} url={match.url} />;
