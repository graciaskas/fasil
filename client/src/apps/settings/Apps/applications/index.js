         ...
         <div className="bodyContainer">
            <div className="main-container bg-gray">
               <div className="row pr-3">
                  {data.map((app, i) => {
                     const { active } = app;
                     const className = active ? "btn bg-o" : "btn btn-primary";
                     const text = active ? "Desinstaller" : "Installer";

                     return (
                        <div
                           className="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-xs-12 col-12"
                           key={i}
                        >
                           <div className="box__user">
                              ...
                              <div className="box__description user">
                                 <h4>{app.name}</h4>
                                 <p>
                                    Lorem, ipsum dolor sit amet elit. Doloribus
                                    vero aliquid.
                                 </p>
