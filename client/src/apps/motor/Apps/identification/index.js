...
const Init = ({ app, name }) => {
   ...
   const { drivers, setDrivers, loadDrivers, getDrivers, database, token } =
            ...
            <div className="headPageTitle">
               <h4>
                  <Link to="/motor/identifications">
                     <span className="link" onClick={() => getDrivers()}>
                        {" "}
                        {name} / {stepUrl}{" "}
                     </span>
                  </Link>
               ...
               <div className="buttons " id="myButtons">
                  ...
                  <Route path="/motor/identifications" exact>
                     {
                        ...
                        stepUrl === "motor" ? (
                           <button className="bg-blue" onClick={createEngine}>
                              {" "}
                              Sauvegarder
                           </button>
                        ) : null
...

                     {
                        ...
                        stepUrl === "owner" ? (
                           <>
                              <button className="bg-blue" onClick={createOwner}>
                                 Sauvegarder{" "}
                              </button>
                              <Link to={"/motor/identifications/"}>
                                 <button className="bg-o">Annuler</button>
                  ...
                  <Route path="/motor/identifications/view" exact>
                     ...
                     <button className="bg-o" onClick={printIdentification}>
                        {" "}
                        Imprimer{" "}
                     </button>
                  </Route>
