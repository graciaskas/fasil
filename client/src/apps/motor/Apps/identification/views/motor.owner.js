...
const Create = (props) => {
   const { step, setStep, loading, setLoading } = useContext(
   ...
   const getEngine = async (id) => {
      try {
         ...
         const request = await fetch(
            URI + "/engines/" + id + "/?database=" + database,
            {
               method: "GET",
   ...
   const setInitialStates = () => {
      //set initial states acconding to url
