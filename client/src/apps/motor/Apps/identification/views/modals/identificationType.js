...
const IdentificationType = ({ display }) => {
   ...
   const locateProp = () => {
      if (data != null) {
         ...
         history.push(
            "/motor/identifications/create?propType=" + value.toLowerCase()
         );
      } else {
         setMessage({
            type: "danger",
   ...
   const close = () => {
      ...
      document.getElementById("m_body_master").classList =
         "modal-body w-40 modal-out";
      setTimeout(function () {
               ...
               <div className="" id="report_master">
                  ...
                  <form className="form">
                     <div style={{ margin: "6px 0px" }}>
                        <p>
                           Pour demarrer avec un enregistrement de
                           l'identification, vous devez selectioner si le motard
                           est un propriétaire ou non.
                        </p>
                     </div>
