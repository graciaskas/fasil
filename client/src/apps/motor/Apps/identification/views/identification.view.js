...
function View({ data }) {
   ...
   const { message, setMessage, printing, setPriting } = useContext(
                        ...
                        <div className="emp-d">
                           ...
                           <div className="employeeDesc">
                              ...
                              {content.isOwner !== true ? (
                                 owner.isPP !== true ? (
                                    <h4 className="status bg-primary d-inline">
                                       {owner.names}
                                    </h4>
                                 ) : null
                              ) : (
                                 <h4 className="status bg-success d-inline">
                                    {" "}
                                    Privé{" "}
                                 </h4>
                              )}
                     ...
                     <div className="pageSingleLinks">
                        ...
                        {!content.isOwner ? (
                           <li
                              className="viewList"
                              id="tutellesBook"
                              onClick={(e) => LoadView(e, "proprietaire")}
                           >
                              Propriétaire
                           </li>
                        ) : null}
