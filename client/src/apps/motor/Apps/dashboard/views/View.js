...
import { useLocation, useParams, useLocation } from "react-router";
                  ...
                  <div className="page-container">
                     ...
                     <div className="pageSingleLinks">
                        ...
                        <li
                           className="viewList"
                           id="autresBook"
                           onClick={(e) => LoadView(e, "autres")}
                        >
                           Autres membres du menage
                        </li>
                     </div>
