...
const Handler = ({ data }) => {
   ...
   if (viewType === "list") return <CooperativesList data={data.data} />;

   return <CooperativeGrids data={data.data} />;
};

const Init = ({ app, name }) => {
   const { createCooperative, deleteCooperative } =
   ...
   const { setLoadAssociations, associations, database, token } =
               ...
               <div className="navbar mt-4 mr-3">
                  <div className="dropdown show">
                     ...
                     <div className="dropdown-menu" aria-labelledby="filters">
                        <Link
                           to={`/motor/cooperatives/create/?q=${id}`}
