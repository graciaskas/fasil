...
const Users = (props) => {
   ...
   const { createUser, updateUser, deleteUser, archiveUser, handleSearch } =
            ...
            <Route path="/motor/parametres/utilisateurs/view" exact>
               <div className="navbar mt-4 mr-3">
                  <div className="dropdown show">
                     <button
                        className="bg-blue d-flex text-white"
                        id="filters"
                     ...
                     <div className="dropdown-menu" aria-labelledby="filters">
                        <Link
                           to={`/motor/parametres/utilisateurs/create/?q=${id}`}
                           className="dropdown-item"
                        >
                           Duplicate
                        </Link>
                        <a className="dropdown-item" onClick={deleteUser}>
                           Delete
                        </a>
