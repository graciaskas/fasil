...
export default function Create_DB(props) {
   ...
   function close() {
      ...
      document.getElementById("m_body_restore").classList =
               ...
               <div className="" id="report_restore">
                  <form className="form" onSubmit={(e) => handleCreation(e)}>
                     ...
                     <div style={{ margin: "6px 0px" }}>
                        ...
                        <p>
                           In order to avoid conflicts between databases, Boopy
                           needs to know if this database was moved or copied.
